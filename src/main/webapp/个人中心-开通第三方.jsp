  ...
  <div class="w1200 personal">
    ...
    <div id="personal-left" class="personal-left">
      <ul>
        ...
        <li class=""><span><a href="#"><i class="dot dot02"></i>开通第三方</a> </span> </li>
        <li><span><a href="#"><i class="dot dot03"></i>充值</a></span></li>
        <li class=""><span><a href="#"><i class="dot dot04"></i>提现</a></span></li>
        <li style="position:relative;" class=""> <span> <a href="#"> <i class="dot dot06"></i> 我的红包 </a> </span> </li>
        <li class=""><span><a style="font-size:14px;text-align:center;width:115px;padding-right:35px;" href="#">兑换历史</a></span></li>
        <li class=""><span><a href="#"><i class="dot dot07"></i>自动投标</a></span></li>
        <li style="position:relative;"> <span> <a href="#"><i class="dot dot08"></i>系统信息 </a> </span> </li>
