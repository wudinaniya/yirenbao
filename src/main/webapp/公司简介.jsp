  ...
  <div class="header-top min-width">
    <div class="container fn-clear"> <strong class="fn-left">咨询热线：400-848-6698<span class="s-time">服务时间：9:00 - 18:00</span></strong>
      ...
      <ul class="fn-right header-top-ul">
        ...
        <li>
          <div class=""><a href="javascript:;" class="js-login" title="登录">登录</a></div>
        </li>
      </ul>
    </div>
  </div>
  <div class="header min-width">
    <div class="container">
      ...
      <ul class="top-nav fn-clear">
        ...
        <li> <a href="#">我要融资</a> </li>
        <li> <a href="#">安全保障</a> </li>
        <li class="top-nav-safe"> <a href="/about-7">我的账户</a> </li>
        <li> <a href="#">关于我们</a> </li>
      </ul>
    </div>
  </div>
...
<div class="bg">
  <div class="contain" id="tabs" style="margin:0 auto;">
    <div class="text-nav">
      <ul class="clearfix">
        <li> <a class="text-link" href="网站公告.html">网站公告</a> </li>
        <li> <a class="text-link" href="媒体报道.html">媒体报道</a> </li>
        <li class="selected"> <a class="text-link" href="公司简介.html">公司简介</a> </li>
        <li> <a class="text-link" href="管理团队.html">管理团队</a> </li>
        <li> <a class="text-link" href="合作伙伴.html">合作伙伴</a> </li>
        <li> <a class="text-link" href="团队风采.html">团队风采</a> </li>
        <li> <a class="text-link" href="法律政策.html">法律政策</a> </li>
        <li> <a class="text-link" href="法律声明.html">法律声明</a> </li>
        <li> <a class="text-link" href="资费说明.html">资费说明</a> </li>
        <li> <a class="text-link" href="招贤纳士.html">招贤纳士</a> </li>
        <li> <a class="text-link" href="联系我们.html">联系我们</a> </li>
      </ul>
    </div>
    <div class="text-box">
    ...
    <div class="ft-service">
      <dl>
        <dd>
          ...
          <div class="ft-serv-handle clearfix"><a class="icon-hdSprite icon-ft-sina a-move a-moveHover" title="阳光易贷新浪微博" target="_blank" href="http://weibo.com/p/1006065369665393/home?from=page_100606&mod=TAB#place"></a><a class="icon-hdSprite icon-ft-qqweibo a-move a-moveHover" title="阳光易贷腾讯微博" target="_blank" href="http://e.t.qq.com/ygydai?pgv_ref=im.perinfo.perinfo.icon"></a><a class="icon-ft-qun a-move a-moveHover" title="阳光易贷QQ群" target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=ad0ad5a8c1d09ac24357aff7f6c6f4eb6367ef0f972ae5a9f31d570d7e98a0c9"></a><a class="icon-hdSprite icon-ft-email a-move a-moveHover mrn" title="阳光易贷email" target="_blank" href="mailto:xz@ygydai.com"></a></div>
        </dd>
      </dl>
    </div>
